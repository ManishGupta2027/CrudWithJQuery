...
btAppAdmin.directive('delightMeter', function () {
    ...
    */
    function link($scope, $element, $attrs) {
        ...
        document.getElementById("arc5").setAttribute("d", objDelightMeterArc.describeArc(200, 200, 100, -90, -35));           //--Left first arc    Orange
        document.getElementById("arc2").setAttribute("d", objDelightMeterArc.describeArc(200, 200, 100, -60, 20));
        document.getElementById("arc1").setAttribute("d", objDelightMeterArc.describeArc(200, 200, 100, 0, 90));          //--Left first arc    red
        //
    ...
    return {
        restrict: 'E',
        templateUrl: '/assets-lib/js/svgmeter.html',
        scope: {
            score: '=ngModel'
        },
        link: link
...
btAppAdmin.controller('delightMeterController', function ($scope) {
